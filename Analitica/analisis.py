    ...
    consultas = [
        {
            ...
            "sql": """
                ...
                JOIN dim_choferes C ON H.id_chofer = C.id_chofer
                WHERE 
        ...
        },
        {
            ...
            "sql": """
                ...
                JOIN dim_tipos_servicio TS ON HR.id_tipo_servicio = TS.id_tipo_servicio
                WHERE 
        ...
        },
        {
            ...
            "sql": """
                ...
                FROM hechos_reservas_analisis H
                JOIN dim_vehiculos V ON H.id_vehiculo = V.id_vehiculo
                WHERE 
                    EXTRACT(YEAR FROM H.fecha) = %s AND
                    H.estado = 'Completada'
